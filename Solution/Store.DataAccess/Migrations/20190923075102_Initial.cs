        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameEdition = table.Column<string>(maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "PrintingEditionsInOrders",
                columns: table => new
                {
                    OrderId = table.Column<int>(nullable: false),
                    PrintingEditionId = table.Column<int>(nullable: false),
                    OrderAmount = table.Column<double>(nullable: false),
                    PrintEditionQuantity = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrintingEditionsInOrders", x => new { x.OrderId, x.PrintingEditionId });
                    table.ForeignKey(
                        name: "FK_PrintingEditionsInOrders_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PrintingEditionsInOrders_PrintingEditions_PrintingEditionId",
                        column: x => x.PrintingEditionId,
                        principalTable: "PrintingEditions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrintingEditionsInOrders_PrintingEditionId",
                table: "PrintingEditionsInOrders",
                column: "PrintingEditionId");
        }
